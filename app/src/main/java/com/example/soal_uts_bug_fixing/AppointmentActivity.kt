...
class AppointmentActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, TimePicker.DialogExit.DialogListener
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            submitBtn.setOnClickListener {
                if(fieldNotEmpty()){
                    val dialog = TimePicker.DialogExit()
